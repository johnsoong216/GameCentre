...
public class GameActivity extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boardManager = loadsaveManager.loadFromFile(StartingActivity.TEMP_SAVE_FILENAME, username);
    ...
    private void updateTileButtons() {
        ...
        if (boardManager.puzzleSolved()) {
            ...
            loadsaveManager.saveToFile(StartingActivity.TEMP_SAVE_FILENAME, username, boardManager);
            loadsaveManager.saveToFile(StartingActivity.SAVE_FILENAME, username, boardManager);
        }
    }
